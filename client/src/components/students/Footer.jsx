 ...
 export default function Footer() {
    return (
        <>
            ...
            <footer className="flex flex-col bg-emerald-100 items-center justify-around w-full py-16 text-sm text-gray-800/70">
                ...
                <p className="mt-8 text-center">Copyright © 2025 <a href="https://">My School</a>. All rights reservered.</p>
            </footer>
        </>
    );
};